<template>
  <div class="shareButtons flex gap-x-3">
    <button class="relative" @click="copyClipboard">
      <Transition name="fade">
        <div
          v-if="showTooltip"
          class="copyTooltip bg-theme_light p-2 rounded text-xs absolute bottom-0 mb-9 whitespace-nowrap"
        >
