  ...
  <Layout>
    ...
    >
      <div class="content__404 absolute z-3 top-0 left-0 p-16 lg:(mt-18 ml-10)">
        <h1 class="text-5rem font-medium mb-3">404</h1>
        <h2 class="text-xl text-2xl mb-3">
          Oops, the page you're looking for does not exist.
        </h2>
        <p class="text-sm">You may want to head back to the homepage.</p>
        <g-link
          to="/"
          class="mt-4 bg-theme_light px-5 py-2 w-max flex justify-center items-center gap-x-1 text-sm transition-colors hover:bg-theme_bg cursor-pointer"
        >
          Return Home
        </g-link>
      </div>
      ...
      >
        <div
          class="w-full bg-theme_dark opacity-80 h-screen-50vh lg:h-screen-60vh xl:h-screen-70vh absolute top-0 right-0 left-0"
        ></div>
        <h1
...
.text__404 {
  ...
  color: transparent;
  text-shadow: 0 0 5px $theme_dark;
}
</style>
